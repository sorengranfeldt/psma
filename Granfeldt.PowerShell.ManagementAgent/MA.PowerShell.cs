...
namespace Granfeldt
{
    public partial class PowerShellManagementAgent : IDisposable, IMAExtensible2GetCapabilities, IMAExtensible2GetSchema, IMAExtensible2GetParameters, IMAExtensible2CallImport, IMAExtensible2CallExport, IMAExtensible2Password
    {
        ...
        static void Verbose_DataAdded(object sender, DataAddedEventArgs e) => Tracer.TraceInformation("verbose {0}", ((PSDataCollection<VerboseRecord>)sender)[e.Index].ToString());
        static void Warning_DataAdded(object sender, DataAddedEventArgs e) => Tracer.TraceWarning("warning {0}", 1, ((PSDataCollection<WarningRecord>)sender)[e.Index]);
        static void Debug_DataAdded(object sender, DataAddedEventArgs e) => Tracer.TraceInformation("debug {0}", ((PSDataCollection<DebugRecord>)sender)[e.Index].ToString());
        static void Progress_DataAdded(object sender, DataAddedEventArgs e) => Tracer.TraceInformation("progress {0}", ((PSDataCollection<ProgressRecord>)sender)[e.Index].ToString());
